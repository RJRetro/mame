...
static INPUT_PORTS_START( startrek )
	...
	//DISABLE SECOND COIN BUTTON
	PORT_MODIFY("D7D6")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 )  PORT_NAME("Coin") PORT_IMPULSE(3)  /* P1.5 */
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNUSED ) PORT_IMPULSE(3)  /* P1.8 */
	//END
	...
	PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_START1 )
	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_START2 )
	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_BUTTON2 )	PORT_NAME("Impulse")
	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_BUTTON1 )	PORT_NAME("Phaser")
	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_BUTTON3 )	PORT_NAME("Photon Torpedo")
	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON4 )	PORT_NAME("Warp")
