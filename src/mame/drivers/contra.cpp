...
static INPUT_PORTS_START( contra )
	...
	PORT_MODIFY("P1")
	PORT_BIT( 0x10, IP_ACTIVE_LOW, button1 ) PORT_PLAYER(1) PORT_NAME("P1 Shoot")
	PORT_BIT( 0x20, IP_ACTIVE_LOW, button2 ) PORT_PLAYER(1) PORT_NAME("P1 Jump")

	PORT_START("P2")
	KONAMI8_B12_UNK(2)
	
	PORT_MODIFY("P2")
	PORT_BIT( 0x10, IP_ACTIVE_LOW, button1 ) PORT_PLAYER(2) PORT_NAME("P2 Shoot")
	PORT_BIT( 0x20, IP_ACTIVE_LOW, button2 ) PORT_PLAYER(2) PORT_NAME("P2 Jump")
