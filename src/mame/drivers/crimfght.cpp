...
static INPUT_PORTS_START( crimfght )
	...
	PORT_MODIFY("P1")
	PORT_BIT( 0x10, IP_ACTIVE_LOW, button1 ) PORT_PLAYER(1) PORT_NAME("P1 Punch")
	PORT_BIT( 0x20, IP_ACTIVE_LOW, button2 ) PORT_PLAYER(1) PORT_NAME("P1 Kick")

	PORT_START("P2")
	KONAMI8_B123_START(2)
	
	PORT_MODIFY("P2")
	PORT_BIT( 0x10, IP_ACTIVE_LOW, button1 ) PORT_PLAYER(2) PORT_NAME("P2 Punch")
	PORT_BIT( 0x20, IP_ACTIVE_LOW, button2 ) PORT_PLAYER(2) PORT_NAME("P2 Kick")
...
static INPUT_PORTS_START( crimfghtu )
	...
	PORT_MODIFY("DSW2")
		...
		KONAMI8_B12_UNK(1)
		PORT_BIT( 0x10, IP_ACTIVE_LOW, button1 ) PORT_PLAYER(1) PORT_NAME("P1 Punch")
		ORT_BIT( 0x20, IP_ACTIVE_LOW, button2 ) PORT_PLAYER(1) PORT_NAME("P1 Kick")

		PORT_MODIFY("P2")
		KONAMI8_B12_UNK(2)
		PORT_BIT( 0x10, IP_ACTIVE_LOW, button1 ) PORT_PLAYER(2) PORT_NAME("P2 Punch")
		ORT_BIT( 0x20, IP_ACTIVE_LOW, button2 ) PORT_PLAYER(2) PORT_NAME("P2 Kick")

		PORT_MODIFY("P3")
		KONAMI8_B12_UNK(3)
		PORT_BIT( 0x10, IP_ACTIVE_LOW, button1 ) PORT_PLAYER(3) PORT_NAME("P3 Punch")
		ORT_BIT( 0x20, IP_ACTIVE_LOW, button2 ) PORT_PLAYER(3) PORT_NAME("P3 Kick")

		PORT_MODIFY("P4")
		KONAMI8_B12_UNK(4)
		PORT_BIT( 0x10, IP_ACTIVE_LOW, button1 ) PORT_PLAYER(4) PORT_NAME("P4 Punch")
		ORT_BIT( 0x20, IP_ACTIVE_LOW, button2 ) PORT_PLAYER(4) PORT_NAME("P4 Kick")
