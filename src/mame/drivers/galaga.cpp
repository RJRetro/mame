...
static INPUT_PORTS_START( galaga )
	...
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNUSED ) PORT_COCKTAIL //B2
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_START1 )
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START2 )

	PORT_START("IN0H")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 )	PORT_NAME("Coin")
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNUSED ) // COIN 2
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 )
	PORT_SERVICE( 0x08, IP_ACTIVE_LOW )

	PORT_START("IN1L")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT ) PORT_NAME("Right") PORT_2WAY
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT )  PORT_NAME("Left")  PORT_2WAY

	PORT_START("IN1H")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNUSED ) PORT_COCKTAIL // RIGHT
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNUSED ) PORT_2WAY PORT_COCKTAIL // LEFT
...
static INPUT_PORTS_START( digdug )
	...
	PORT_START("IN1H")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNUSED ) PORT_4WAY PORT_COCKTAIL //UP
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNUSED ) PORT_4WAY PORT_COCKTAIL //RIGHT
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNUSED ) PORT_4WAY PORT_COCKTAIL// DOWN
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNUSED ) PORT_4WAY PORT_COCKTAIL // LEFT
