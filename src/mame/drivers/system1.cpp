...
static INPUT_PORTS_START( wboy )
	...
	// PORT_MODIFY P1, P2 AND SYSTEM
	PORT_MODIFY("P1")
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON1 )		PORT_NAME("Speed / Attack")
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON2 )		PORT_NAME("Jump")
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNUSED )    		/* down - unused */
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNUSED )    		/* up - unused */
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT ) PORT_NAME("Right") 	PORT_2WAY
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT )  PORT_NAME("Left") 	PORT_2WAY

	PORT_MODIFY("P2")
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNUSED ) PORT_COCKTAIL //b1
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNUSED ) PORT_COCKTAIL //b2
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNUSED )    /* down - unused */
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNUSED )    /* up - unused */
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNUSED ) PORT_2WAY PORT_COCKTAIL //RIGHT
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED ) PORT_2WAY PORT_COCKTAIL //LEFT
...
static INPUT_PORTS_START( wbml )
	...
	PORT_MODIFY("P1")
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 )		PORT_NAME("P1 Jump")
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON1 )		PORT_NAME("P1 Sword")

	PORT_MODIFY("P2")
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 ) 		PORT_NAME("P2 Jump")	PORT_COCKTAIL
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON1 ) 		PORT_NAME("P2 Sword")	PORT_COCKTAIL
