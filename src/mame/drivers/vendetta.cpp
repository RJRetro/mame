...
static INPUT_PORTS_START( vendet4p )
	...
	PORT_MODIFY("P3")
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_NAME("P3 Punch") PORT_PLAYER(3)
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_NAME("P3 Kick") PORT_PLAYER(3)

	PORT_START("P4")
	KONAMI8_RL_B12_COIN(4)
	
	PORT_MODIFY("P4")
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_NAME("P4 Punch") PORT_PLAYER(4)
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_NAME("P4 Kick") PORT_PLAYER(4)
